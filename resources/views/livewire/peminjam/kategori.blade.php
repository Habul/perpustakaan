        ...
        <div class="collapse navbar-collapse order-3" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @else
                    @if ($count > 0)
                        <li class="nav-item">
                            <a class="nav-link @yield('menu-keranjang-active')" href="/keranjang">Keranjang <span
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('logout') }}" method="POST">
                ...
                <div class="modal-footer justify-content-between">
                    <button class="btn btn-light" data-dismiss="modal"><i class="fa fa-times"></i> Tidak</button>
